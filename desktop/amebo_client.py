...
site.addsitedir("../../prmp_websockets/prmp_websockets")

from prmp_websockets import PRMP_WebSocketClient
from amebo_client_models import *


URI = "ws://localhost:8000"


R = Callable[[Json], None]
...
class Action:
    ...
    def add_receiver(self, receiver: R):
        if receiver and receiver not in self.receivers:
            self.receivers.append(receiver)

    def remove_receiver(self, receiver: R):
